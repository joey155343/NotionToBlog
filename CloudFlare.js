  ...
  const MY_DOMAIN = 'stock-portfolio.cf';
   ...
   */
  const SLUG_TO_PAGE = {
    '': 'a11098e9d34543cda3b264f8914f0380',
    'free': '1eb1a56ddc82454781cc3770c7816197',
    'tw': '59fc349e7b554d2cafbaa20ba3e554b6',
    'customized': '5a7088808fe24f77b65b370e96c2da10',
    'us': '80d730ef108d423ba1dcdcc7cf020c05',
  };
  
  /* Step 3: enter your page title and description for SEO purposes */
  const PAGE_TITLE = '全自動化的股票管理表 stock-portfolio';
  const PAGE_DESCRIPTION = `免費建立副本，操作簡單，立即輕鬆管理股票。自動計算已實現/未實現損益(率)、內化報酬率，視覺化圖表，輕鬆分類股票，同時管理多家券商、自動記錄市值變化`;
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-4111BN27CE"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
  
    gtag('config', 'G-4111BN27CE');
  </script>`;
